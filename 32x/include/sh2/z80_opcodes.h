/*
 * z80_opcodes.h — Z80 opcode enumerations
 *
 * Ported from Marat Fayzullin's Z80 core (Z80OpcodeEnums.h).
...
enum CodesED
{
  ...
  IN_C_xC, OUT_xC_C, ADC_HL_BC, LD_BC_xWORDe, DB_4C, RETI, DB_4E, LD_R_A,
