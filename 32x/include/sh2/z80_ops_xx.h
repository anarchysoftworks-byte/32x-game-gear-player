/*
 * z80_ops_xx.h — DD/FD-prefix opcode table case statements
 * Ported from Marat Fayzullin's Z80 core (CodesXX.h)
 * Included from z80.c inside CodesDD()/CodesFD() switch.
 * XX macro must be defined to IX or IY before inclusion.
 */
...
case ADD_xHL:  I=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));
               M_ADD(I);break;
...
case SUB_xHL:  I=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));
               M_SUB(I);break;
...
case AND_xHL:  I=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));
               M_AND(I);break;
...
case OR_xHL:   I=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));
               M_OR(I);break;
...
case ADC_xHL:  I=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));
               M_ADC(I);break;
...
case SBC_xHL:  I=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));
               M_SBC(I);break;
...
case XOR_xHL:  I=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));
               M_XOR(I);break;
...
case CP_xHL:   I=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));
               M_CP(I);break;
...
case DEC_xHL:  I=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W));M_DEC(I);
               gg_write(R->XX.W+(int8_t)gg_read(R->PC.W++),I);
               break;
...
case INC_xHL:  I=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W));M_INC(I);
               gg_write(R->XX.W+(int8_t)gg_read(R->PC.W++),I);
               break;
...
case NOP:  break;
case OUTA: gg_out(gg_read(R->PC.W++),R->AF.B.h);break;
case INA:  R->AF.B.h=gg_in(gg_read(R->PC.W++));break;
...
case LD_xHL_B: J.W=R->XX.W+(int8_t)gg_read(R->PC.W++);
               gg_write(J.W,R->BC.B.h);break;
...
case LD_xHL_C: J.W=R->XX.W+(int8_t)gg_read(R->PC.W++);
               gg_write(J.W,R->BC.B.l);break;
...
case LD_xHL_D: J.W=R->XX.W+(int8_t)gg_read(R->PC.W++);
               gg_write(J.W,R->DE.B.h);break;
...
case LD_xHL_E: J.W=R->XX.W+(int8_t)gg_read(R->PC.W++);
               gg_write(J.W,R->DE.B.l);break;
...
case LD_xHL_H: J.W=R->XX.W+(int8_t)gg_read(R->PC.W++);
               gg_write(J.W,R->HL.B.h);break;
...
case LD_xHL_L: J.W=R->XX.W+(int8_t)gg_read(R->PC.W++);
               gg_write(J.W,R->HL.B.l);break;
...
case LD_xHL_A: J.W=R->XX.W+(int8_t)gg_read(R->PC.W++);
               gg_write(J.W,R->AF.B.h);break;

case LD_xBC_A: gg_write(R->BC.W,R->AF.B.h);break;
case LD_xDE_A: gg_write(R->DE.W,R->AF.B.h);break;

case LD_B_xHL:    R->BC.B.h=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));break;
case LD_C_xHL:    R->BC.B.l=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));break;
case LD_D_xHL:    R->DE.B.h=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));break;
case LD_E_xHL:    R->DE.B.l=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));break;
case LD_H_xHL:    R->HL.B.h=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));break;
case LD_L_xHL:    R->HL.B.l=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));break;
case LD_A_xHL:    R->AF.B.h=gg_read(R->XX.W+(int8_t)gg_read(R->PC.W++));break;
...
case LD_H_BYTE:   R->XX.B.h=gg_read(R->PC.W++);break;
case LD_L_BYTE:   R->XX.B.l=gg_read(R->PC.W++);break;
case LD_A_BYTE:   R->AF.B.h=gg_read(R->PC.W++);break;
case LD_xHL_BYTE: J.W=R->XX.W+(int8_t)gg_read(R->PC.W++);
                  gg_write(J.W,gg_read(R->PC.W++));break;

case LD_xWORD_HL:
  J.B.l=gg_read(R->PC.W++);
  J.B.h=gg_read(R->PC.W++);
  gg_write(J.W++,R->XX.B.l);
  gg_write(J.W,R->XX.B.h);
  break;

case LD_HL_xWORD:
  J.B.l=gg_read(R->PC.W++);
  J.B.h=gg_read(R->PC.W++);
  R->XX.B.l=gg_read(J.W++);
  R->XX.B.h=gg_read(J.W);
  break;
...
case EX_HL_xSP:
  J.B.l=gg_read(R->SP.W);gg_write(R->SP.W++,R->XX.B.l);
  J.B.h=gg_read(R->SP.W);gg_write(R->SP.W--,R->XX.B.h);
  R->XX.W=J.W;
  break;
